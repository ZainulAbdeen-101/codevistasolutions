    ...
    <div className="-mx-4 flex flex-wrap lg:justify-between">
      <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
        <div className="mb-12 max-w-[570px] lg:mb-0">
          <span className="text-[#082C4E] mb-4 block text-base font-semibold">
            Contact Us
          </span>
          <h2
            className="text-dark mb-6 text-[32px] text-[#3098F3] font-bold font-font uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]"
          >
          ...
          <div className="mb-8 flex w-full max-w-[370px]">
            ...
            <div className="w-full">
              <h4 className="text-dark mb-1 text-xl font-bold font-font">Our Location</h4>
          ...
          <div className="mb-8 flex w-full max-w-[370px]">
            ...
            <div className="w-full">
              <h4 className="text-dark mb-1 text-xl font-bold font-font">Phone Number</h4>
          ...
          <div className="mb-8 flex w-full max-w-[370px]">
            ...
            <div className="w-full">
              <h4 className="text-dark mb-1 text-xl font-bold font-font">Email Address</h4>
          ...
          <form>
            <div className="mb-6">
              <input
                ...
                className="text-body-color border-[f0f0f0] focus:border-[#3098F3] w-full rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
              />
            </div>
            <div className="mb-6">
              <input
            ...
            <div className="mb-6">
              <textarea
                ...
                className="text-body-color border-[f0f0f0] focus:border-[#3098F3] w-full resize-none rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
              ></textarea>
            </div>
            <div>
              <button
                type="submit"
                className="bg-[#3098F3]  w-full rounded border p-3 text-white transition hover:bg-opacity-90"
              >
                Send Message
              </button>
            </div>
